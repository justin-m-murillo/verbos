  ...
  return (
    <Form {...form}>
      <div className='sm:w-420 flex-center flex-col'>
        ...
        <h2 className='h3-bold sm:h2-bold'>Create a new account</h2>
        <p className='text-light-3 small-medium md:base-regular mt-2'>To use Verbôs, please enter your details</p>
